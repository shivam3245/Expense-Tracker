        ...
        <div className="flex items-center justify-center pb-2 bg-gray-100">
            <div className="bg-white p-8 rounded-lg w-full max-w-md shadow-lg">
                ...
                <form onSubmit={handleExpense} className="flex flex-col gap-4">
                    <div>
                        <label htmlFor="text" className="text-lg">Expense Detail</label>
                        <input
                            ...
                            className="w-full text:xs md:text-lg p-2 border-b border-black focus:outline-none"
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            className="w-full text:xs md:text-lg p-2 border-b text-black border-black focus:outline-none"
                        />
                        <div className='text-sm md:text-md'>
                        <h1>Note: If it is expense add amount using (-) sign</h1></div>
                    </div>
